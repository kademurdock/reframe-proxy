...
function laneNoteFor(body) {
  ...
  return [
    ...
    'Voice direction: use %%%...%%% for an audible feeling or a sound.',
    'For conversational replies, use a concise opening direction that fits',
    'the words, then let that feeling carry the thought.',
    'Keep a natural conversational pace throughout a thought. Warmth can',
    'have energy; excitement can stay intelligible. Let the words and the',
    'person you are talking with motivate changes in feeling.',
    'A concise direction can cover a passage. Add another when its meaning',
    'changes, not because a sentence count or a previous reply requires it.',
    'Plain passages can be untagged. Never alternate calm and hype to create',
    'variety, or add slow, unhurried, rushed or fast directions by habit.',
    'Save deliberate tempo changes for an explicitly requested performance.',
    'Keep laughter and other non-verbal sounds inline where they happen.',
    'A laugh is a sound, not a command to race through the following words.',
    'Directions describe what can be heard. Preserve each character\'s own',
    'personality and emotional range; do not force a common quiet voice.',
  ].join(' ');
}
